...
export function Hero() {
  return (
    <section className="relative w-full bg-slate-50 min-h-screen pt-24 md:pt-28 pb-16 sm:pb-20 overflow-hidden">
      {/* Glow Background */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* WARNING BANNER */}
        <div className="w-full bg-yellow-50 border border-yellow-200 text-yellow-800 text-sm py-3 px-4 rounded-lg text-center shadow-sm">
        ...
        <div className="mt-10 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
            className="rounded-2xl overflow-hidden shadow-xl bg-white flex items-center justify-center p-6"
          >
            <img
              src="/eye1.png"
              alt="Glaucoma AI"
